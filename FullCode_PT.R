...
# angledamped <- scan("/Users/selmalerke/PycharmProjects/fysmat2/angledampedpi2.txt", what="", sep="\n")
# timesdamped <- scan("/Users/selmalerke/PycharmProjects/fysmat2/timesdampedpi2.txt", what="", sep="\n")
...
makeplot_with_and_without_noise = function(data, xaxis, yaxis, wnoise, xwaxis, ywaxis){
  ggplot(data = data, aes(xaxis, yaxis)) + 
    theme_bw() +  
    geom_point(data = wnoise, aes(x = xwaxis, y = ywaxis, shape = "Wrong", color = "Wrong"), size = 0.5, stroke = 1.5) +
    geom_point(aes(shape = "True", color = "True"), col = "blue", size = 0.5) + 
    labs(title = plottitle, subtitle = plotsubtitle) + 
    labs(x = "Time(s)", y = expression(paste("Angle ", theta, " (rad)"))) +
    theme(plot.title = element_text(hjust = 0.5, size = 18),
          plot.subtitle = element_text(hjust = 0.5))+
    scale_shape_manual(name = "Frequency", values = c(Wrong = 16, True = 16)) +
    scale_color_manual(name = "Frequency", values = c(Wrong = "tomato1", True = "blue"))
}
...
# Define pendulum 
df=pendulum(R_real, theta0, runtime, nummeasurements)
# df_wrong =pendulum(0.3, theta0, runtime, 1000)
# 
# makeplot_with_and_without_noise(df, df$Time, df$Angle, df_wrong, df_wrong$Time, df_wrong$Angle)
...
# 
# set.seed(16)
# testing_true = fit_model_once(df_true, theta0, L, sigma_theta, prior_sigma_theta_mu=sigma_theta, prior_sigma_theta_var, range_sigma_theta_upper)
...
# 
# savecomparehisttitlesigmatheta = "Comp_DP_TP2_pi5_003.pdf"
# savecomparehisttitleR= "Comp_DP_TP_R2_pi5_003.pdf"
# comparemodshist(meanlist_damped, meanlist_true, "DP", "TP")
...
plot_histogram_free_scale(meanlist_freq_inf, tot_means_inf, "LP_inf_histogram.pdf")
plot_histogram_free_scale(meanlist_freq, tot_means, "LP_basis_histogram.pdf")
...
savecomparehisttitleR = "LP_compinfbasisR.pdf"
savecomparehisttitlesigmatheta = "LP_compinfbasissigmatheta.pdf"
...
#ONSDAG TP with different start angles
...
#pi2
# angledamped <- scan("angledampedpi2.txt", what="", sep="\n")
# timesdamped <- scan("timesdampedpi2.txt", what="", sep="\n")

# theta0=pi/10 #Starting angle in radians BASIS = pi/5
# sigma_theta=0.015 #Angle measurement noise. BASIS = 0.03
# prior_sigma_theta_mu=0.01 #Goes into STAN code. Mean of sigma_theta. BASIS = 0.02
# prior_sigma_theta_var = 0.02 #Goes into STAN code. Variance of sigma_theta. BASIS = 0.04
# range_sigma_theta_upper = 0.03 #Goes into STAN code. Upper value of sigma_theta. BASIS = 0.06
# 
# df_truepi10 = pendulum_true(theta0, runtime, h, m, g, L, I, nummeasurements)
# 
# meanlist_pi10 = fit_model(df_truepi10, seeds, theta0, L, sigma_theta, prior_sigma_theta_mu, prior_sigma_theta_var, range_sigma_theta_upper)
# meanlist_pi10 = meanlist_pi10[3:4]
# tot_means_pi10 = maketot_means(meanlist_pi10)
# 
# # # Make histogram ready list
# meanlist_pi10$sample=1:nrow(meanlist_pi10)
# meanlist_freq_pi10 <- melt(meanlist_pi10, id.vars = "sample")
...
# range_sigma_theta_upper = 0.06 #Goes into STAN code. Upper value of sigma_theta. BASIS = 0.06
# 
# df_truepi5= pendulum_true(theta0, runtime, h, m, g, L, I, nummeasurements)
# 
# meanlist_pi5 = fit_model(df_truepi5, seeds, theta0, L, sigma_theta, prior_sigma_theta_mu, prior_sigma_theta_var, range_sigma_theta_upper)
# meanlist_pi5 = meanlist_pi5[3:4]
# tot_means_pi5 = maketot_means(meanlist_pi5)
# 
# # # Make histogram ready list
# meanlist_pi5$sample=1:nrow(meanlist_pi5)
# meanlist_freq_pi5 <- melt(meanlist_pi5, id.vars = "sample")
# 
# theta0=pi/2.5 #Starting angle in radians BASIS = pi/5
# sigma_theta=0.06 #Angle measurement noise. BASIS = 0.03
# prior_sigma_theta_mu=0.04 #Goes into STAN code. Mean of sigma_theta. BASIS = 0.02
# prior_sigma_theta_var = 0.08 #Goes into STAN code. Variance of sigma_theta. BASIS = 0.04
# range_sigma_theta_upper = 0.12 #Goes into STAN code. Upper value of sigma_theta. BASIS = 0.06
# 
# 
# df_truepi2 = pendulum_true(theta0, runtime, h, m, g, L, I, nummeasurements)
# 
# meanlist_pi2 = fit_model(df_truepi2, seeds, theta0, L, sigma_theta, prior_sigma_theta_mu, prior_sigma_theta_var, range_sigma_theta_upper)
# meanlist_pi2 = meanlist_pi2[3:4]
# tot_means_pi2 = maketot_means(meanlist_pi2)
# 
# # # Make histogram ready list
# meanlist_pi2$sample=1:nrow(meanlist_pi2)
# meanlist_freq_pi2 <- melt(meanlist_pi2, id.vars = "sample")
# 
# 
# savecomparehisttitlesigmatheta = "Comppi10pi5sigmatheta.pdf"
# savecomparehisttitleR= "Comppi10pi5R.pdf"
# comparemodshist(meanlist_pi10, meanlist_pi5, "pi/10", "pi/5")
# 
# savecomparehisttitlesigmatheta = "Comppi10pi2sigmatheta.pdf"
# savecomparehisttitleR= "Comppi10pi2R.pdf"
# comparemodshist(meanlist_pi10, meanlist_pi2, "pi/10", "pi/2.5")
# 
# savecomparehisttitlesigmatheta = "Comppi2pi5sigmatheta.pdf"
# savecomparehisttitleR= "Comppi5pi2R.pdf"
# comparemodshist(meanlist_pi2, meanlist_pi5, "pi/2.5", "pi/5")
